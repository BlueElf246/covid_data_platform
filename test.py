...
if __name__ == "__main__":
    ...
    query = """
        ...
        select * from r1
        """
    table_lists = [('cleaned_today',trs_df1),('yesterday',yesterday_df),('dim_country_code_scd',dim_country_scd_df)]
    
    final_df = s3.query_data_spark(spark_session, table_lists, query)

    print(dim_country_scd_df.show(50))
    # s3.write_parquet_spark(final_df, bucket, target_table1, mode="append", partition_col=None)
